...
namespace Recommended_System.Controllers
{
    public class ItemController : Controller
    {
        ...
        // internet search
        //public ActionResult InternetSearch()
        //{
        //    string searchQuery = Request["InternetSearch"];
        //    string cx = "000444561497760690246:wgrt0ssxerw";
        //    string apiKey = "AIzaSyADbMMi2EHAy9uGPUYB1R8EMR_OJcOKlzw";
        //    var request = WebRequest.Create("http://wwww.googleapis.com/customsearch/v1?key=" +apiKey + "&cx=" +cx + "&q=" + searchQuery);
